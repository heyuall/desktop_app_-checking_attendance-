...
#
# Created: Tue May  8 15:59:40 2018
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox.setItemText(0, _translate("Dialog", "IA1.2", None))
        self.comboBox.setItemText(1, _translate("Dialog", "IA1.1", None))
        self.comboBox.setItemText(2, _translate("Dialog", "IA2.1", None))
        self.pushButton_2.setText(_translate("Dialog", "Add / Delete student", None))
