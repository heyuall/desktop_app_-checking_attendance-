...
#
# Created: Wed May  9 20:15:54 2018
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox.setItemText(2, _translate("Dialog", "EI1_1", None))
        self.comboBox.setItemText(3, _translate("Dialog", "MEC1_1", None))
        self.pushButton.setText(_translate("Dialog", "Add Student", None))
        self.pushButton_2.setText(_translate("Dialog", "Delete Student", None))
    ...
    def button_click(self):
        ...
        if ((ch11.__eq__("")) or(ch22.__eq__(""))):
            ...
            data_test.insert2(str(classe),str(ch1),str(ch2))
    ...
    def button_click2(self):
        ...
        if ((ch11.__eq__("")) or(ch22.__eq__(""))):
            ...
            data_test.efface(str(classe),ch11,ch22)
